{
  /*fetch interview questions to be asked from api and sends to step 2 */
}
          ...
          <div className="space-y-6">
            <div className="relative ">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 outling-none transition"
              ...
              >
                ...
                {resumeFile && (
                  <motion.button
                    ...
                    className="mt-4 bg-gray-900 text-white px-5 rounded-lg hover:bg-gray-800 transition"
                  >
